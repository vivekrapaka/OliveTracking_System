      ...
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-8 py-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            >
              <SelectTrigger className={cn("mt-1", validationErrors.projectId && "border-red-300")}>
            ...
            {validationErrors.projectId && (
              <p className="text-red-600 text-sm mt-1">{validationErrors.projectId}</p>
            )}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="mb-4">
                  ...
                  <Input
                    ...
                    className={cn("mt-1", validationErrors.taskName && "border-red-300")}
                  />
                  {validationErrors.taskName && (
                    <p className="text-red-600 text-sm mt-1">{validationErrors.taskName}</p>
                  )}
                </div>
                ...
                <div className="mb-4">
                  ...
                  <Select value={taskType} onValueChange={setTaskType}>
                    <SelectTrigger className={cn("mt-1", validationErrors.taskType && "border-red-300")}>
                  ...
                  {validationErrors.taskType && (
                    <p className="text-red-600 text-sm mt-1">{validationErrors.taskType}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <Select value={priority} onValueChange={setPriority}>
                    <SelectTrigger className={cn("mt-1", validationErrors.priority && "border-red-300")}>
                  ...
                  {validationErrors.priority && (
                    <p className="text-red-600 text-sm mt-1">{validationErrors.priority}</p>
                  )}
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className={cn("mt-1", validationErrors.developmentDueHours && "border-red-300")}
                      min="0"
                      step="0.5"
                      placeholder="0"
                    />
                    {validationErrors.developmentDueHours && (
                      <p className="text-red-600 text-xs mt-1">{validationErrors.developmentDueHours}</p>
                    )}
                  </div>
                  <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Task Configuration</h3>
                
                {/* Status */}
                <div className="mb-4">
                  <Label className="text-sm font-medium text-gray-700">Status *</Label>
                  <Select value={status} onValueChange={setStatus}>
                    <SelectTrigger className={cn("mt-1", validationErrors.status && "border-red-300")}>
                ...
                {/* Document Path */}
                <div className="mb-4">
                  <Label htmlFor="documentPath" className="text-sm font-medium text-gray-700">Document Path</Label>
                  <Input
                    id="documentPath"
                    value={documentPath}
                ...
                {/* Commit ID */}
                <div>
                  <Label htmlFor="commitId" className="text-sm font-medium text-gray-700">Commit ID</Label>
                  <Input
                    id="commitId"
                    value={commitId}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {validationErrors.receivedDate && (
                      <p className="text-red-600 text-sm mt-1">{validationErrors.receivedDate}</p>
                    )}
                  </div>
